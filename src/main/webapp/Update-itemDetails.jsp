  ...
  <form action="ItemController">
    <div class="form-row">
       ...
       <div class="input-data">
        <input type="text" name="itemdetailsid" value="${existedItem.item_details_id}" required>
        <div class="underline"></div>
        <label>ITEMDETAILSID</label>
      </div>
      
      
      <div class="input-data">
        <input type="text" name="type" value="${existedItem.type_model}" required>
        <div class="underline"></div>
        <label>Type</label>
      </div>
      <div class="input-data">
